package net.ovonsame.config.blockly.blocks;
...
public class ComponentFromLocalizedTextBlock implements IBlockGenerator {
   public void generateBlock(BlocklyToCode master, Element block) throws TemplateGeneratorException {
      ...
      if (text != null) {
         master.append("Component.translatable(");
   ...
   public String[] getSupportedBlocks() {
      return new String[]{"component_from_localized_text"};
   }
