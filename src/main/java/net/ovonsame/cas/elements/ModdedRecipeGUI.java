...
public class ModdedRecipeGUI extends ModElementGUI<ModdedRecipe> {
    ...
    public ModdedRecipeGUI(MCreator mcreator, ModElement modElement, boolean editingMode) {
    ...
    @Override public void openInEditingMode(ModdedRecipe recipe) {
    ...
    @Override public ModdedRecipe getElementFromGUI() {
